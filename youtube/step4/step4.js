...
const search = (query) => {
  ...
  const SEARCH_URL = `https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=25&q=${query}&key=AIzaSyDVZO1z2Pj_anIwt1gosV-D6JbcbPZTye8`
  ...
  for(let i=0;i<vitems.length;i++){
    ...
    videoList.push(`<img src = '${vitems[i].snippet.thumbnails.medium.url}'</img>`)
    videoList.push(`<div>`)
